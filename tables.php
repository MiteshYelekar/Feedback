...
<body  style= "background: url(http://getwallpapers.com/wallpaper/full/3/b/8/789629-free-yellow-colour-wallpaper-1920x1200.jpg);  
  ...
  <br><br>
   <marquee scrollamount="17">PLEASE SELECT YOUR RATING FOR MENTOR IN APPROPRIATE FIELDS</marquee>
   <br><br><br><br><br><br>
    <div>
      <form method="post">
      <table  border ="1" align="center">
       ...
       <tr>
           <td style="padding:10px"><b>Course content knowledge</b> </td>
       ...
       <tr>
           <td style="padding:10px"><b>Pace of teaching</b> </td>
       ...
       <tr>
           <td style="padding:10px"><b>Stimulated interest in subject</b> </td>
       ...
       <tr>
           <td style="padding:10px"><b>Impartiality</b> </td>
   ...
   <button type="submit" class="btn btn-primary" name="submitf" value="Inser Record" >            SUBMIT FEEDBACK </button>
