...
$db = mysqli_connect('localhost', 'root', '', 'feed')or die("Could not connect to database");
...
{   
    ...
    $user_check_queryf = "SELECT * FROM feedvalues WHERE username='$usern' LIMIT 1";
  ...
  { 
    ...
    $en5=$_POST['e'];
   	...
   	$query = "INSERT INTO feedvalues (username,en1,en2,en3,en4,en5) 
